/*
 * @(#)XStringBuffer.java	1.62 00/04/21
 *
 ...
 * <p><blockquote><pre>
 *     x = new XStringBuffer().append("a").append(4).append("c")
 *                           .toString()
 * </pre></blockquote>
 ...
 * <p>
 * The principal operations on a <code>XStringBuffer</code> are the 
 ...
 * <p>
 * In general, if sb refers to an instance of a <code>XStringBuffer</code>, 
 ...
 * 
 * 
 *	This is a slightly improved version of java.lang.XStringBuffer
 *	it has a direct access method to the underlying char[]
 */
 
public final class XStringBuffer implements java.io.Serializable
{
     ...
     * synchronized.
     *
     * @see java.lang.XStringBuffer#ensureCapacity(int)
     */
     ...
     * @see        java.lang.XStringBuffer#length()
     */
		...
		value[count] = '\0';
            ...
            if (shared) {
                if (newLength > 0) {
                    ...
                    // If newLength is zero, assume the XStringBuffer is being
     ...
     * @return  a reference to this <code>XStringBuffer</code> object.
     * @see     java.lang.String#valueOf(java.lang.Object)
     * @see     java.lang.XStringBuffer#append(java.lang.String)
     */
    public synchronized XStringBuffer append(Object obj) {
     ...
     *
     * @param   str   a string.
     * @return  a reference to this <code>XStringBuffer</code>.
     */
    public synchronized XStringBuffer append(String str) {
	if (str == null) {
     ...
     * to this <code>XStringBuffer</code> object.
     *
     * @param   str   the characters to be appended.
     * @return  a reference to this <code>XStringBuffer</code> object.
     */
    public synchronized XStringBuffer append(char str[]) {
	int len = str.length;
	int newcount = count + len;
	if (newcount > value.length)
	    expandCapacity(newcount);
     ...
     * @return  a reference to this <code>XStringBuffer</code> object.
     */
    public synchronized XStringBuffer append(char str[], int offset, int len) {
        int newcount = count + len;
	if (newcount > value.length)
	    expandCapacity(newcount);
     ...
     * @see     java.lang.XStringBuffer#append(java.lang.String)
     */
    public XStringBuffer append(boolean b) {
     ...
     * <code>XStringBuffer</code> object.
     *
     * @param   c   a <code>char</code>.
     * @return  a reference to this <code>XStringBuffer</code> object.
     */
    public synchronized XStringBuffer append(char c) {
     ...
     * @see     java.lang.XStringBuffer#append(java.lang.String)
     */
    public XStringBuffer append(int i) {
     ...
     * @return  a referenct to this <code>XStringBuffer</code> object.
     * @see     java.lang.String#valueOf(long)
     * @see     java.lang.XStringBuffer#append(java.lang.String)
     */
    public XStringBuffer append(long l) {
     ...
     * @see     java.lang.XStringBuffer#append(java.lang.String)
     */
    public XStringBuffer append(float f) {
     ...
     * @see     java.lang.XStringBuffer#append(java.lang.String)
     */
    public XStringBuffer append(double d) {
	return append(String.valueOf(d));
    }

    /**
     * Removes the characters in a substring of this <code>XStringBuffer</code>.
     * The substring begins at the specified <code>start</code> and extends to
     * the character at index <code>end - 1</code> or to the end of the
     * <code>XStringBuffer</code> if no such character exists. If
     ...
     * @since      1.2
     */
    public synchronized XStringBuffer delete(int start, int end) {
	if (start < 0)
     ...
     * <code>XStringBuffer</code> (shortening the <code>XStringBuffer</code>
     * by one character).
     *
     ...
     * @since       1.2
     */
    public synchronized XStringBuffer deleteCharAt(int index) {
        if ((index < 0) || (index >= count))
	    throw new StringIndexOutOfBoundsException();
	if (shared)
	    copy();
    ...
    /**
     * Replaces the characters in a substring of this <code>XStringBuffer</code>
     * with characters in the specified <code>String</code>. The substring
     * begins at the specified <code>start</code> and extends to the character
     * at index <code>end - 1</code> or to the end of the
     * <code>XStringBuffer</code> if no such character exists. First the
     * characters in the substring are removed and then the specified
     * <code>String</code> is inserted at <code>start</code>. (The
     * <code>XStringBuffer</code> will be lengthened to accommodate the
     ...
     * @since      1.2
     */ 
    public synchronized XStringBuffer replace(int start, int end, String str) {
        if (start < 0)
	    throw new StringIndexOutOfBoundsException(start);
	if (end > count)
	    end = count;
     ...
     * characters currently contained in this <code>XStringBuffer</code>.The 
     * substring begins at the specified index and extends to the end of the
     * <code>XStringBuffer</code>.
     * 
     * @param      start    The beginning index, inclusive.
     ...
     * <code>XStringBuffer</code> increases by <code>len</code> characters.
     *
     ...
     * @since 1.2
     */
    public synchronized XStringBuffer insert(int index, char str[], int offset,
                                                                   int len) {
        if ((index < 0) || (index > count))
	    throw new StringIndexOutOfBoundsException();
     ...
     * @see        java.lang.String#valueOf(java.lang.Object)
     * @see        java.lang.XStringBuffer#insert(int, java.lang.String)
     * @see        java.lang.XStringBuffer#length()
     */
    public synchronized XStringBuffer insert(int offset, Object obj) {
     ...
     * @see        java.lang.XStringBuffer#length()
     */
    public synchronized XStringBuffer insert(int offset, String str) {
     ...
     * <code>XStringBuffer</code>  object at the position indicated by
     * <code>offset</code>.
     *
     * @param      offset   the offset.
     * @param      str      a character array.
     ...
     * @exception  StringIndexOutOfBoundsException  if the offset is invalid.
     */
    public synchronized XStringBuffer insert(int offset, char str[]) {
	if ((offset < 0) || (offset > count)) {
	    throw new StringIndexOutOfBoundsException();
	}
	int len = str.length;
     ...
     * @see        java.lang.XStringBuffer#length()
     */
    public XStringBuffer insert(int offset, boolean b) {
     ...
     * this <code>XStringBuffer</code> object at the position indicated by
     * <code>offset</code>.
     * <p>
     * The offset argument must be greater than or equal to 
     * <code>0</code>, and less than or equal to the length of this 
     ...
     * @see        java.lang.XStringBuffer#length()
     */
    public synchronized XStringBuffer insert(int offset, char c) {
	int newcount = count + 1;
	if (newcount > value.length)
	    expandCapacity(newcount);
	else if (shared)
     ...
     * @see        java.lang.XStringBuffer#length()
     */
    public XStringBuffer insert(int offset, int i) {
     ...
     * @see        java.lang.XStringBuffer#length()
     */
    public XStringBuffer insert(int offset, long l) {
     ...
     * @see        java.lang.XStringBuffer#length()
     */
    public XStringBuffer insert(int offset, float f) {
     ...
     * @see        java.lang.XStringBuffer#length()
     */
    public XStringBuffer insert(int offset, double d) {
     ...
     *
     * @return  a reference to this <codeXStringBuffer</code> object..
     * @since   JDK1.0.2
     */
    public synchronized XStringBuffer reverse() {
	if (shared) copy();
	int n = count - 1;
    ...
    // convert a XStringBuffer into a String.  They are not public.
    // They shouldn't be called by anyone but String.
    final void setShared() { shared = true; } 
    public final char[] getValue() { return value; }

    /**
     * readObject is called to restore the state of the XStringBuffer from
     * a stream.
     */
