 ...
 *
 */
public class CopyToClipboardTask
        extends CopyTask
{
	protected int trashCId;

	public CopyToClipboardTask(GameSource src, int clip, int trash) throws Exception
	{
		super(src, clip, false);    //  no need to calc Idx in clipboard
		trashCId = trash;
	}
		...
		throws Exception
	{
		...
		/*	empty the clipboard	*/
		gutil.moveCollectionContents(targetCId,trashCId, false, calcIdx);
    }
